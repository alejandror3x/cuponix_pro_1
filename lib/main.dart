...
final _router = GoRouter(
  routes: [
    ...
    GoRoute(
      path: '/recover-email',
      builder: (_, _) => const RecoverEmailScreen(),
    ),
    GoRoute(
      path: '/recover-sent',
      builder: (_, _) => const RecoverSentScreen(),
    ),
    GoRoute(
      path: '/recover-user',
      builder: (_, _) => const RecoverUserScreen(),
    ),
    ...
    GoRoute(path: '/guardados', builder: (_, _) => const GuardadosScreen()),
    ...
    GoRoute(path: '/seguidores', builder: (_, _) => const SeguidoresScreen()),
    GoRoute(
      path: '/solicitud-cupon',
      builder: (_, _) => const SolicitudCuponScreen(),
    ),
    GoRoute(
      path: '/solicitud-canje',
      builder: (_, _) => const SolicitudCanjeScreen(),
    ),
    GoRoute(
      path: '/canjear-puntos',
      builder: (_, _) => const CanjearPuntosScreen(),
    ),
    GoRoute(path: '/mostrar-qr', builder: (_, _) => const MostrarQrScreen()),
    GoRoute(path: '/sin-puntos', builder: (_, _) => const SinPuntosScreen()),
    GoRoute(
      path: '/gracias-visitar',
      builder: (_, _) => const GraciasVisitarScreen(),
    ),
    ...
    GoRoute(
      ...
      builder: (_, _) => const BuscarResultadosScreen(),
    ),
    GoRoute(path: '/usar-cupon', builder: (_, _) => const UsarCuponScreen()),
    GoRoute(
      path: '/mostrar-codigo',
      builder: (_, _) => const MostrarCodigoScreen(),
    ),
    GoRoute(
      path: '/gracias-cupon',
      builder: (_, _) => const GraciasCuponScreen(),
    ),
    GoRoute(
      path: '/points-help',
      builder: (_, _) => const PointsHelpScreen(),
    ),
    GoRoute(
    ...
    GoRoute(
      path: '/editar-perfil-config',
      builder: (_, _) => const EditProfileSettingsScreen(),
    ),
    ...
    GoRoute(
      ...
      builder: (_, _) => const SubscriptionStatusScreen(active: true),
    ),
    GoRoute(
      path: '/plan-gratis',
      builder: (_, _) => const SubscriptionStatusScreen(active: false),
    ),
  ],
);
